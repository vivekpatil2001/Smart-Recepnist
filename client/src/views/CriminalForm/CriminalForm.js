...
const CriminalForm = () => {
  ...
  return (
    <>
      ...
      <h2 className='text-pink-600 text-center text-4xl my-6'>Criminal Information Form</h2>
      ...
      <button type='button' className="bg-pink-600 hover:bg-pink-800 text-white  py-2 px-5 my-4 rounded-lg text-xl block mx-auto"  ><Link to="/criminalData" className='text-white no-underline'>  Get Criminal Data →</Link></button>
