...
const PatientForm = () => {
  ...
  return (
    <>
      ...
      <h2 className='text-pink-600 text-center text-4xl my-6'>Patient Registration Form</h2>
      <div className="form-container">
        ...
        <form role='form' encType='multipart/form-data'>
          <div className='form-container-2'>
            <div className="form-section">
              ...
              <div className="form-group">
                <label className='font-semibold text-lg'>Patient ID (Adhar/PAN):</label>
                <input type="text"
                  className='input-box'
      ...
      <button type='button' className="bg-pink-600 hover:bg-pink-800 text-white  py-2 px-5 my-4 rounded-lg text-xl block mx-auto"  ><Link to="/patientData" className='text-white no-underline'>  Get Patient Data →</Link></button>
